...
-   Added  : Video in documentation showing you the steps on how to upgrade Talexa
-   Updated : Minor bug fixes
...
✅ Added WooCommerce Integration — sync products,categories,  stock, and orders seamlessly between your online store and POS

✅ Added QuickBooks Integration for advanced accounting and auto-syncing invoices and clients

✅ Upgraded to Laravel 12 — Talexa now requires PHP ≥ 8.2

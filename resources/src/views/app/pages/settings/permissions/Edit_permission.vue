                            ...
                            <b-col md="6">
                              <div class="psx-form-check">
                                <input
                                  ...
                                  id="perm_dashboard"
                                >
                                <label class="psx-form-check-label" for="perm_dashboard">
                      ...
                      <b-card-body>
                        ...
                        <b-row>
                          <b-col md="6" class="mb-2">
                            <div class="psx-form-check">
                              <input type="checkbox" v-model="permissions" value="Store_settings_view" class="psx-checkbox psx-form-check-input" id="perm_store_settings_view">
                              <label class="psx-form-check-label" for="perm_store_settings_view">

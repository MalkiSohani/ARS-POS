          ...
          <b-col lg="12" md="12" sm="12">
            <b-card no-body :header="$t('SystemSettings')">
              <b-card-body>
                <b-row>
                    ...
                    >
                      <b-form-group :label="$t('footer') + ' ' + '*'">
                         <b-form-input
                          ...
                          class="form-control"
                          value="TALEXA POS - Ultimate Inventory With POS"
                          readonly
                        ></b-form-input>
                        <b-form-invalid-feedback
                          id="footer-feedback"
                  ...
                  <b-col lg="4" md="4" sm="12">
                    ...
                    >
                      <b-form-group label="Point To Amount Rate *  ( Example: 1 Point = 0.10$)">
                        ...
                        <b-form-invalid-feedback id="point-to-amount-feedback">
                  ...
                  <b-col md="2" sm="2" class="mt-4 mb-4">
                    <div class="psx-form-check">
                      <input type="checkbox" v-model="setting.is_invoice_footer" class="psx-checkbox psx-form-check-input" id="is_invoice_footer">
                      <label class="psx-form-check-label" for="is_invoice_footer">
                        <h5>{{$t('invoice_footer')}}</h5>
                      </label>
                    </div>
                  </b-col>
                 ...
                 <b-col md="4" class="mt-4 mb-4">
                    <div class="psx-form-check">
                      <input type="checkbox" v-model="setting.quotation_with_stock" class="psx-checkbox psx-form-check-input" id="quotation_with_stock">
                      <label class="psx-form-check-label" for="quotation_with_stock">
                        <h5>{{$t('Create_Quotation_with_Stock')}}</h5>
                      </label>
                    </div>
                </b-col>
                ...
                <b-col md="4" class="mt-4 mb-4">
                    <div class="psx-form-check">
                      <input type="checkbox" v-model="setting.show_language" class="psx-checkbox psx-form-check-input" id="show_language">
                      <label class="psx-form-check-label" for="show_language">
                        <h5>{{$t('Show_Languages')}}</h5>
                      </label>
                    </div>
                </b-col>
...
export default {
  ...
  created: function() {
    ...
    this.setting.developed_by = "Talentfort";
    this.setting.footer = "TALEXA POS - Ultimate Inventory With POS";

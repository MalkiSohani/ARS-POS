<template>
  <div>
    ...
    <b-card class="mt-3" header="Auto Sync Guide (Talexa → WooCommerce)">
      <b-card-text>
        <p class="mb-2"><strong>What it does</strong></p>
        <ul class="mb-3">
          <li>Products: Pushes products from Talexa to WooCommerce (create/update).</li>
          <li>Stock: Pushes stock quantities/status from Talexa to WooCommerce.</li>
        </ul>
        ...
        <ul class="mb-3">
          <li>Products tab: <em>Run Manual Sync Now</em> or <em>Sync Only Unsynced</em> (Talexa → WooCommerce).</li>

    ...
    <div v-else>
      ...
      >
        ...
        <template slot="table-row" slot-scope="props">
          ...
          <span v-else-if="props.column.field === 'cost'" class="pre">{{ props.row.type === 'Variable' ? firstLine(props.row.cost) : props.row.cost }}</span>
          <span v-else-if="props.column.field === 'price'" class="pre">{{ props.row.type === 'Variable' ? firstLine(props.row.price) : props.row.price }}</span>

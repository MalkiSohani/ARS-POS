          ...
          <b-col lg="12" class="mb-4">
            ...
            <div class="form-section">
              <div class="section-header">
                <i class="i-File-New section-icon"></i>
                  ...
                  <table class="table table-hover table-modern">
                    ...
                    <tbody>
                      <tr v-for="variant in variants" :key="variant.var_id">
                        ...
                        <td><b-form-input v-model="variant.cost" type="number" size="sm"></b-form-input></td>
                        <td><b-form-input v-model="variant.price" type="number" size="sm"></b-form-input></td>
                        <td><b-form-input v-model="variant.wholesale" type="number" size="sm"></b-form-input></td>
                        <td><b-form-input v-model="variant.min_price" type="number" size="sm"></b-form-input></td>
            ...
            <div class="form-section" v-if="product.type == 'is_single'">
              <div class="section-header">
                <i class="i-Bag-2 section-icon"></i>
            ...
            <div class="form-section">
              <div class="section-header">
                <i class="i-Settings section-icon"></i>
...
<style>
  ...
  .badge-primary-light {
    background-color: rgba(9, 99, 172, 0.1);
    color: #0963AC;

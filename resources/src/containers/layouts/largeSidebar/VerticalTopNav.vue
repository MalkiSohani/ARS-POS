<template>
  <div class="vertical-top-nav">
    ...
    <div class="nav-right">
      ...
      <!-- Fullscreen Toggle -->
      <button class="nav-icon-btn" @click="handleFullScreen" title="Fullscreen">
      ...
      <div class="dropdown">
        ...
        >
          <template slot="button-content">
            <span class="badge badge-primary" v-if="notifs_alert > 0">{{ notifs_alert }}</span>
            <i class="i-Bell"></i>
          </template>
          <vue-perfect-scrollbar
            :settings="{ suppressScrollX: true, wheelPropagation: false }"
...
.vertical-top-nav button.dropdown-toggle-no-caret:active {
  ...
  color: #0963AC  !important;
  border-color: #0963AC  !important;

...
//------------------------------------------------------------------\\
    ...
    // payhere
    Route::post('payhere/notify', 'PayHereController@handleNotification')->name('payhere.notify');
    Route::get('payhere/return', 'PayHereController@handleReturn')->name('payhere.return');
    Route::get('payhere/cancel', 'PayHereController@handleCancel')->name('payhere.cancel');
